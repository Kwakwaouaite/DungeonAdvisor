...
// from http://wpf-animation.googlecode.com/svn/trunk/src/WPF/Animation/PennerfloatAnimation.cs
public class Tween : MonoBehaviour 
{
	   ...
	   public enum Equations
		...
		static EaseFunction [] g_FunctionTable =
		{
			Linear,
            QuadEaseOut, QuadEaseIn, QuadEaseInOut, QuadEaseOutIn,
            ExpoEaseOut, ExpoEaseIn, ExpoEaseInOut, ExpoEaseOutIn,
		...
		public static EaseFunction GetEaseFunction(Equations equation) { return  g_FunctionTable[(int)equation]; }
